...
public class CBU_PROFIT_UploadForecast_OutlookXY extends Driver_Script {
	...
	static ExtentTest test =cbu_Profit_DriverScript.Driver_Script.test;
	 ...
	 public static void uploadForecastOutlookXY() throws Exception {
		 test = report.startTest("Test Execution Started in -----> Upload Forecast OutlookXY");
		 try { 
						
			forecastType ="Outlook x+y";
		    reportingPeriod ="2017";
		    forecastProject = "PROFIT Automation";
			forecastAssumption = "PROFIT auto";
			forecastAuthor = "USHD";
			percentileCase = "P50";
			String uploadFilePath = Input_DataSource.OutlookXYUploadFilePath;
